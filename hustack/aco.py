...
def aco_enumerator(problem,swarm=_B,n_partials=50,n_cutoff=10,n_return=5,iterations=10,depth=_B,q_prob=.71,alpha=1.36,beta=1.38,omega=3,phi=.43,chi=1.77,gamma=.4,kappa=2.34,sigma=12,rho=.62,width=4,value_function=_default_value_function,finalize_policy=_default_finalize_policy,seed=_B,time_limit=3e1,verbose=_A):
...
def aco_solver(problem,swarm=_B,n_partials=50,n_cutoff=10,iterations=40,depth=_B,q_prob=.72,alpha=1.36,beta=1.38,omega=3,phi=.43,chi=1.77,gamma=.4,kappa=2.34,sigma=12,rho=.62,width=4,value_function=_default_value_function,finalize_policy=_default_finalize_policy,seed=_B,time_limit=3e1,verbose=_A):
